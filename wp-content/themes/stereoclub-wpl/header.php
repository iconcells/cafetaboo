...
<div id="header" class="header">
    <div class="container">
    	<div class="four columns">
        	<div id="mainlogo" class="logo"><div class="inner"><a href="http://350taxi.com/CafeTaboo/home/"><img src="http://cafetaboo.net/cafetaboo/wp-content/uploads/2014/05/logo.png"<?php if ( $de_logo_file ) { echo $de_logo;} else{ echo get_template_directory_uri();
