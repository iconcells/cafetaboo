...
<div id="header" class="header">
    <div class="container">
    	<div class="four columns">
        	<div id="mainlogo" class="logo"><div class="inner"><a href="http://cafetaboo.net/"><img src="http://350taxi.com/CafeTaboo/home/wp-content/uploads/sites/2/2013/09/logo.png"<?php if ( $de_logo_file ) { echo $de_logo;} else{ echo get_template_directory_uri();
