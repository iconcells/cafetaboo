...
$of_options[] = array( 	"name" 		=> "Hello there!",
						"desc" 		=> "",
						"id" 		=> "introduction",
						"std" 		=> "<h3 style=\"margin: 0 0 10px;\">Welcome to the Lezzatos theme options</h3>
						Your theme version is 1.2.2",
						"icon" 		=> true,
						"type" 		=> "info"
				);
...
$of_options[] = array( 	"name" 		=> "Accent Color",
						"desc" 		=> "Pick an accent color for overall colors (default: #C71628).",
						"id" 		=> "DE_accent_color",
						"std" 		=> "",
						"type" 		=> "color"
				);
...
$of_options[] = array( 	"name" 		=> "Header Background Color",
						"desc" 		=> "Pick a background color for the header (default: #C71628).",
...
$of_options[] = array( 	"name" 		=> "Footer Background Color",
						"desc" 		=> "Pick a background color for the footer (default: #C71628).",
...
$of_options[] = array( 	"name" 		=> "Menu Background Color",
						"desc" 		=> "Pick a background color for the menu (default: #C71628).",
...
$of_options[] = array( 	"name" 		=> "Menu Background Hover Color",
						"desc" 		=> "Pick a background color for the menu hover (default: #da292a).",
...
$of_options[] = array( 	"name" 		=> "Menu Font",
						"desc" 		=> "Specify the body font properties",
						"id" 		=> "DE_menu_font",
						"std" 		=> array('size' => '17px','face' => 'default','style' => 'normal'),
						"type" 		=> "typography"
				); 
...
$of_options[] = array( 	"name" 		=> "Menu Per Page",
						"desc" 		=> "Number of menu item per page. Insert -1 to show unlimited item per page.",
						"id" 		=> "DE_menu_per_page",
						"std" 		=> "12",
						"type" 		=> "text"
				);
...
$of_options[] = array( 	"name" 		=> "Send email to",
...
$of_options[] = array( 	"name" 		=> "Start Time",
						"desc" 		=> "Format 00:00",
						"id" 		=> "DE_time_open",
						"std" 		=> "08:00",
						"type" 		=> "text"
...
$of_options[] = array( 	"name" 		=> "Close Time",
						"desc" 		=> "Format 00:00",
						"id" 		=> "DE_time_close",
						"std" 		=> "22:00",
						"type" 		=> "text"
...
$of_options[] = array( 	"name" 		=> "Interval between time (in minutes, default is 30)
",
						"desc" 		=> "",
						"id" 		=> "DE_time_step",
						"std" 		=> "30",
...
$of_options[] = array( 	"name" 		=> "Autoslide",
						"desc" 		=> "",
						"id" 		=> "DE_slider_autoslide",
						"std" 		=> 1,
						"type" 		=> "switch"
				);

$of_options[] = array( 	"name" 		=> "Fit Always",
...
$of_options[] = array( 	"name" 		=> "Show slider text on smaller screen",
						"desc" 		=> "",
						"id" 		=> "DE_slider_text_mobile",
						"std" 		=> 0,
						"type" 		=> "switch"
				);
