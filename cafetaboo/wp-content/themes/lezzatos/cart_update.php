...
if(isset($_GET["cart_plus"]) && $_GET["cart_plus"]==1)
{
	
	$product_code 	= filter_var($_GET["p_code"], FILTER_SANITIZE_STRING); //product code
	$product_qty 	= filter_var($_GET["qty"], FILTER_SANITIZE_NUMBER_INT); //product code
	$return_url 	= base64_decode($_GET["return_url"]); //return url
...
if(isset($_GET["cart_minus"]) && $_GET["cart_minus"]==1)
{
